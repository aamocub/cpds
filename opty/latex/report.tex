...
The following subsections explore how varying parameters affect the percentage of transactions that commit successfully.
...
% With 25 clients, the number of clients is more than double the number of entries, and successful transactions are 41.9\%.

% TODO maybe do again w/ 50 entries, reformat paragraph above to reflect 2RD2WR
...
\addplot plot[turquesa, error bars/.cd, y dir=both, y explicit] table [
    col sep=semicolon,
    x=SubsetSize,
    y=DesvTip,
    % y error plus=MaxMinusAvg,
